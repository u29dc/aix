...
export const CHATGPT_BUTTON_CLASS_FALLBACK =
	'inline-flex items-center justify-center relative shrink-0 select-none disabled:pointer-events-none disabled:opacity-50 text-white font-semibold border border-transparent transition duration-100 rounded-md px-3 h-8 min-w-[4rem] whitespace-nowrap text-xs';
